...
turf
	New_Konoha_Gates
		density=0
		icon='pngs/konoha-gates-entrance.PNG'
		layer=MOB_LAYER+1
		side
			icon='pngs/konoha-gate1.png'
		side_2
			icon='pngs/konoha-gate2.png'
		path
			layer=OBJ_LAYER
			icon='pngs/entrance_path.png'
...
turf
	...
	Demonic_Statue
		density=1
		icon='pngs/Demonic Statue of the Outer Path.png'
		layer=MOB_LAYER+1

	Sound
		icon='icons/sound.dmi'
		density = 1
		Insignia
			icon_state="Insignia"
		Wall
