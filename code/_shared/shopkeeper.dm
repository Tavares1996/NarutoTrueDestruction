obj
	sale
		...
		Sand_Gourd
			...
			icon_state="gui"
			refr=/obj/items/equipable/Sand_Gourd
			cost=8000
		Straw_Hat
			icon='members/strawhat.dmi'
			icon_state="gui"
			refr=/obj/items/equipable/Straw_Hat
			cost=1500
		Obito_Goggles
			icon='members/Obito_Goggles.dmi'
			icon_state="gui"
			refr=/obj/items/equipable/Obito_Goggles
			cost=3000
		Uchiha_Shirt
			icon='members/uchiha_shirt.dmi'
			icon_state="gui"
			refr=/obj/items/equipable/Uchiha_Shirt
			cost=6500
		Arm_Guards
...
obj/sale/newsys
	...
	Anbu_Armor
		...
		cost=3000
	Blitzkrieg_Cloak
		refr=/obj/items/equipable/newsys/Blitzkrieg_Cloak
		cost=10000
	Madara_Mask
		refr=/obj/items/equipable/newsys/Madara_Mask
		cost=7000
	Shippuden_Gaara
		refr=/obj/items/equipable/newsys/Shippuden_Gaara
		cost=2500
	Shippuden_Naruto
		refr=/obj/items/equipable/newsys/Shippuden_Naruto
		cost=2500
	EGO_Sash
		refr=/obj/items/equipable/newsys/EGO_Sash
		cost=3000
	Purple_Sash
		refr=/obj/items/equipable/newsys/Purple_Sash
		cost=3000
	Lee_Suit
		refr=/obj/items/equipable/newsys/Lee_Suit
		cost=3000
	Light_Purple_Sash
		refr=/obj/items/equipable/newsys/Light_Purple_Sash
		cost=3000
	Black_Sash
		refr=/obj/items/equipable/newsys/Black_Sash
		cost=3000
	Kankuro_Suite
		refr=/obj/items/equipable/newsys/Kankuro_Suite
		cost=5000
	Sennin_Suite
		refr=/obj/items/equipable/newsys/Sennin_Suite
		cost=5000
	Haku_Mask
		refr=/obj/items/equipable/newsys/Haku_Mask
		cost=4000
	Cigarettes
		refr=/obj/items/equipable/newsys/Cigarettes
		cost=2500
