				...
				if(pindex)
					if(istype(src,/obj/gui/passives/str))
						if(usr.skillspassive[25]>=1 && usr.skillspassive[src.pindex]<src.max)
							var/number = input(usr,"How many points would you like to buy","Strength") as num
							if(number <= src.max && number <= usr.skillspassive[25] && number>= 0)
								usr.skillspassive[25]-= number
								usr.skillspassive[src.pindex]+=number
								usr<<"Bought passive!"
					...
					if(istype(src,/obj/gui/passives/rfx))
						if(usr.skillspassive[26]>=1 && usr.skillspassive[src.pindex]<src.max)
							var/number = input(usr,"How many points would you like to buy","Reflex") as num
							if(number <= src.max && number <= usr.skillspassive[26]&& number>= 0)
								usr.skillspassive[26]-= number
								usr.skillspassive[src.pindex]+=number
								usr<<"Bought passive!"
								for(var/obj/gui/passives/gauge/Q in world)
									if(Q.pindex==26)
					...
					if(istype(src,/obj/gui/passives/int))
						if(usr.skillspassive[27]>=1 && usr.skillspassive[src.pindex]<src.max)
							var/number = input(usr,"How many points would you like to buy","Intelligence") as num
							if(number <= src.max && number <= usr.skillspassive[27]&& number>= 0)
								usr.skillspassive[27]-= number
								usr.skillspassive[src.pindex]+=number
								usr<<"Bought Passive!"
								for(var/obj/gui/passives/gauge/Q in world)
									if(Q.pindex==27)
					...
					if(istype(src,/obj/gui/passives/con))
						if(usr.skillspassive[28]>=1 && usr.skillspassive[src.pindex]<src.max)
							var/number = input(usr,"How many points would you like to buy","Control") as num
							if(number <= src.max && number <= usr.skillspassive[28]&& number>= 0)
								usr.skillspassive[28]-= number
								usr.skillspassive[src.pindex]+=number
								usr<<"Bought Passive!"
								for(var/obj/gui/passives/gauge/Q in world)
									if(Q.pindex==28)
