...
client
	verb
		...
		refresh_options()
			...
			//Items
			winset(src, "options_macro_pane.drop_input", "text=\"[macros["macro.drop.name"]]\"")
			winset(src, "options_macro_pane.get_input", "text=\"[macros["macro.get.name"]]\"")
		...
		refresh_macros()
			...
			if(mob)
				...
				if(macros["macro.use-skill-11.name"] != macro_inputs["options_macro_pane.skill11_input.text"])
					macro_changes["macro.use-skill-11.name"] = macro_inputs["options_macro_pane.skill11_input.text"]
				if(macros["macro.use-skill-12.name"] != macro_inputs["options_macro_pane.skill12_input.text"])
					macro_changes["macro.use-skill-12.name"] = macro_inputs["options_macro_pane.skill12_input.text"]
				if(macros["macro.use-skill-13.name"] != macro_inputs["options_macro_pane.skill13_input.text"])
				...
				//Items
				if(macros["macro.drop.name"] != macro_inputs["options_macro_pane.drop_input.text"])
					macro_changes["macro.drop.name"] = macro_inputs["options_macro_pane.drop_input.text"]
				if(macros["macro.get.name"] != macro_inputs["options_macro_pane.get_input.text"])
					macro_changes["macro.get.name"] = macro_inputs["options_macro_pane.get_input.text"]
